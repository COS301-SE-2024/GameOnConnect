...
class CustomizeProfilePageObject extends State<CustomizeProfilePage> {
    ...
    return Wrap(
      ...
      children: selectedItems
          .map((item) => Chip(
                ...
                onDeleted: () =>
                    onDeleted(item), // Callback when the delete icon is tapped.
                deleteIcon: Icon(
                  Icons.close,
                  size: 16,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          icon:  Icon(Icons.keyboard_backspace, color: Theme.of(context).colorScheme.secondary,),
          onPressed: () {
            ...
            InkWell(
              ...
              child: Container(
                padding: const EdgeInsets.all(
                    5), // Adjust the padding to change the size
                decoration: BoxDecoration(
                  color: Theme.of(context)
                      .colorScheme
                      .primary, // Choose the color of the button
                ...
                child: Icon(
                  ...
                  color: Theme.of(context)
                      .colorScheme
                      .surface, // Choose the color of the icon
        ...
        Row(
          children: <Widget>[
            // title
             Align(
              alignment: Alignment.centerLeft,
              child: Text('Dark mode:', style: TextStyle(fontSize: 15,color:Theme.of(context).colorScheme.secondary)),
            ),
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              Navigator.of(context)
                  .pop(); // Call the save profile data function here
            },
