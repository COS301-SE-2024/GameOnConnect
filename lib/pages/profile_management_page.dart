    ...
    return Scaffold(
        ...
        body: const Column(children: [
          ExpansionTile(
            ...
            children: <Widget>[
              ListTile(
                title: Text('To change your username, navigate to the '
                    'settings on your profile page,and then select the'
                    ' Edit Profile option.'),
              ),
            ...
            children: [
              ListTile(
                title: Text('To change your first name, navigate'
                    ' to the settings on your profile page,and then'
