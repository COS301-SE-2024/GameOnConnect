...
class StatsMoodWidget extends StatefulWidget {
...
class _StatsMoodWidgetState extends State<StatsMoodWidget> {
...
class StatsMoodPage extends StatelessWidget {
